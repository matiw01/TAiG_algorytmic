...
def prod_input_window(backend, prod_frame):
    ...
    button = ttk.Button(frame, width=15, text="Add production", style="my.TButton", command=lambda: add_prod(prod_frame))
...
def main():
    ...
    prod_input_btn = ttk.Button(window_buttons, text="Production input", width=20, command=lambda: prod_input_window(backend, prod_frame), style="my.TButton")
